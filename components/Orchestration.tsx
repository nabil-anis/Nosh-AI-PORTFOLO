    ...
    <section className="pb-20 px-6 bg-white dark:bg-black relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto z-10 relative">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-24 md:mb-32">
          ...
          >
            <span className="text-brand-purple text-[10px] font-black tracking-[0.5em] uppercase mb-8 inline-block drop-shadow-[0_0_8px_rgba(177,83,215,0.4)]">NOSH CAPABILITIES</span>
